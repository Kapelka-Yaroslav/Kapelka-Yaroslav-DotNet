...
namespace Lab5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine(StudContHelper.ToTable(studList, Student.CompareSpecialty, "Компьютерные игры"));
            studList.Reset();
            //Console.WriteLine("Средний возраст группы КИТ-119Б: " + studCalc.AverageAge(Student.CompareGroup, "CIT-119B"));
            Console.WriteLine("Средний возраст группы КИТ-119A: " + StudContCalculator.AverageAge(studList, Student.CompareGroup, "КИТ-119А"));
